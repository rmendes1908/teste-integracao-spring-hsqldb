...
@Sql(value = "/domain-cerveja/load-database.sql", executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
@Sql(value = "/domain-cerveja/clean-database.sql", executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD)
